...
city_data_path = 'Chart Maker/Data/3_year_city_median_closed.csv'
county_data_path = 'Chart Maker/Data/3_year_county_median_closed.csv'
output_path = 'Chart Maker/Data/scatter_data.json'
