...
# Load the data
city_data_path = city_data_path = '/Users/austinwhitt/Desktop/Chart Maker/Data/3_year_city_median_closed.csv'

county_data_path = '3_year_county_median_closed.csv'
